...
exports.buildNewPost = function (startingValue) {
 ...
 exports.addMention = function (mention) {
   // get section to replace
   const cursorPos = document.activeElement.selectionStart
   const atIndex = app.postDraftText.slice(0, cursorPos).lastIndexOf('@')

   // add name to draft
   app.postDraftText = exports.replaceBetween(app.postDraftText, atIndex, cursorPos, `@${ mention.name } `)
