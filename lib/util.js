...
exports.linkifyText = function (input, opts) {
  ...
  if (input.hasOwnProperty('mentions')) {
    ...
    // save names for later searching
  ...
  // TODO:
  // 1. Loop through split text
  // 2. Link to url OR load in image OR link to profile
  ...
  // (dont propagate the event so that the link works)
  if( frag ){
