...
module.exports = class FritterApp {
  ...
  onSourceIndexing (url, startVersion, targetVersion) {
    console.log('onSourceIndexing', url, startVersion, targetVersion)
    this.indexingStatuses[url] = {isIndexing: true, error: false, startVersion, targetVersion}
    rerenderIndexingStatuses()
  }

  onSourceIndexed (url, version) {
    console.log('onSourceIndexed', url, version)
    this.indexingStatuses[url] = {isIndexing: false, error: false, version}
    rerenderIndexingStatuses()
  }
